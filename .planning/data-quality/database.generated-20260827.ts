  ...
  public: {
    Tables: {
      ...
      complex_canonical_jibun: {
        ...
        Relationships: [
          {
            foreignKeyName: "complex_canonical_jibun_complex_id_fkey"
            columns: ["complex_id"]
            isOneToOne: true
            referencedRelation: "complexes"
            referencedColumns: ["id"]
      ...
      complex_jibun_exclusions: {
        ...
        Relationships: [
          {
            foreignKeyName: "complex_jibun_exclusions_complex_id_fkey"
            columns: ["complex_id"]
            isOneToOne: false
            referencedRelation: "complexes"
            referencedColumns: ["id"]
      ...
      facility_kapt: {
        Row: {
          ...
          heat_type: string | null
          households_135: number | null
          households_60: number | null
          households_85: number | null
          households_over135: number | null
          id: string
          kapt_code: string | null
    ...
    Views: {
      complex_canonical_jibun_collisions: {
        Row: {
    ...
    Functions: {
      ...
      complex_historical_max_before: {
        Args: { p_before_date: string; p_complex_ids: string[] }
        Returns: {
          complex_id: string
          max_price: number
        }[]
      }
      complex_integrity_counts: {
        Args: { p_sgg: string[] }
        Returns: {
          empty_kapt: number
          multi_jibun: number
          turnover_anomaly: number
        }[]
      }
      complex_integrity_detail: {
        Args: { p_sgg: string[] }
        Returns: {
          axis: string
          canonical_name: string
      ...
      complex_is_matchable: {
        Args: {
          p_excluded: string[]
          p_id: string
          p_status: Database["public"]["Enums"]["complex_status"]
      ...
      refresh_complex_canonical_jibun: { Args: never; Returns: number }
      refresh_complex_gap_stats: {
        Args: { p_window_months?: number }
        Returns: number
      }
